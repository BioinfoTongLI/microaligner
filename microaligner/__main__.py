...
def parse_cmd_args_to_config() -> PipelineConfig:
    ...
    parser.add_argument('--SaveOutputToCycleStack', dest='SaveOutputToCycleStack', action='store_true')
    parser.add_argument('--no-SaveOutputToCycleStack', dest='SaveOutputToCycleStack', action='store_false')
    parser.set_defaults(SaveOutputToCycleStack=True)
    ...
    parser.add_argument('--UseFullResImage', dest='UseFullResImage', action='store_true')
    parser.add_argument('--no-UseFullResImage', dest='UseFullResImage', action='store_false')
    parser.set_defaults(UseFullResImage=False)
    parser.add_argument('--UseDOG', dest='UseDOG', action='store_true')
    parser.add_argument('--no-UseDOG', dest='UseDOG', action='store_false')
    parser.set_defaults(UseDOG=True)
